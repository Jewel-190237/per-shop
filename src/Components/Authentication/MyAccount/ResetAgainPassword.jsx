    ...
    return (
        ...
        <div className='max-w-[1050px] mx-auto flex-col justify-center  my-4 col-span-2'>
            ...
            <div className='my-6 flex justify-center items-center'>
                <button onClick={() => navigate('/verified')} className=" btn btn-wide bg-[#FF5C2C] text-white rounded-3xl mb-5">Reset password</button>
            </div>
        </div>
...
export default ResetAgainPassword;