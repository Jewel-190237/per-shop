    ...
    return (
        <section>
            ...
            <div className='max-w-[1320px] mx-auto my-10'>
                ...
                <div className='rounded-lg bg-[#FFEBE3] border border-[#FF5C2C] mt-32 p-3'>
                    <div className='flex justify-between items-center px-0 md:px-40 mt-8'>
                        <p className='flex-1 font-bold'>Basic</p>
                        <div className='flex gap-4 justify-between items-center'>
                            <label className='flex-1 w-32'> 
                                <select className='p-3 rounded-lg w-full'>
                                    <option value="">Select</option>
                                    <option value="">A</option>
                                </select>
                            </label>
                            <input className='flex-1 p-3 rounded-lg' type="text" placeholder='$' />
                        </div>
                    </div>
                    <div className='flex justify-between items-center px-0 md:px-40 mt-8'>
                        <p className='flex-1 font-bold'>Standard</p>
                        <div className='flex gap-4 justify-between items-center'>
                            <label className='flex-1 w-32'> 
                                <select className='p-3 rounded-lg w-full'>
                                    <option value="">Select</option>
                    ...
                    <div className='flex justify-between items-center px-0 md:px-40 mt-8'>
                        <p className='flex-1 font-bold'>Premium</p>
                        <div className='flex gap-4 justify-between items-center'>
                            <label className='flex-1 w-32'> 
                                <select className='p-3 rounded-lg w-full'>
                                    <option value="">Select</option>
                ...
                <div className='mt-8'>
                    <div className='flex justify-between'>
                        <div></div>
                        <a href="/overView4"><button className='btn bg-[#FF5C2C] text-white rounded-3xl'>Continue</button>                    </a>
                    </div>
                </div>
            </div>
        </section>
